...
import { AvatarUploadCircle } from "@/core/ui/AvatarUploadCircle";
...
import {
  formationLine,
  isSafeImageSrc,
} from "@/features/profile/about-section-utils";
import { isDbAvatarSrc } from "@/features/profile/avatar-display";
import { uploadProfileAvatarFile } from "@/features/profile/upload-profile-avatar";
            ...
            <div className="mx-auto h-32 w-32 min-h-[128px] min-w-[128px] shrink-0 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-600 md:mx-0">
              {currentDisplayAvatar && isSafeImageSrc(currentDisplayAvatar) ? (
                <Image
                  ...
                  unoptimized={isDbAvatarSrc(currentDisplayAvatar)}
                />
              ) : (
