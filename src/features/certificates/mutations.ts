...
export function validateCertificateCreateInput(
...
export function buildCertificateUpdateData(
...
export type AccountCertificateMutationError = { ok: false; status: number; error: string };
